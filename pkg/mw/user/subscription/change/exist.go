...
func (h *Handler) ExistSubscriptionChange(ctx context.Context) (exist bool, err error) {
...
func (h *Handler) ExistSubscriptionChangeConds(ctx context.Context) (exist bool, err error) {
	handler := &baseQueryHandler{
		Handler: h,
	}
	err = db.WithClient(ctx, func(_ctx context.Context, cli *ent.Client) error {
