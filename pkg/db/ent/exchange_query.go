...
func (eq *ExchangeQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (eq *ExchangeQuery) FirstIDX(ctx context.Context) uint32 {
...
func (eq *ExchangeQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (eq *ExchangeQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (eq *ExchangeQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (eq *ExchangeQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (eq *ExchangeQuery) prepareQuery(ctx context.Context) error {
	...
	if exchange.Policy == nil {
		return errors.New("ent: uninitialized exchange.Policy (forgotten import ent/runtime?)")
	}
	if err := exchange.Policy.EvalQuery(ctx, eq); err != nil {
		return err
	}
	return nil
}
