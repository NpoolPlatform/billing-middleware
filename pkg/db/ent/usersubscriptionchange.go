...
func (*UserSubscriptionChange) scanValues(columns []string) ([]interface{}, error) {
	values := make([]interface{}, len(columns))
	for i := range columns {
		switch columns[i] {
		case usersubscriptionchange.FieldID, usersubscriptionchange.FieldCreatedAt, usersubscriptionchange.FieldUpdatedAt, usersubscriptionchange.FieldDeletedAt:
		...
		default:
			return nil, fmt.Errorf("unexpected column %q for type UserSubscriptionChange", columns[i])
		}
	}
	return values, nil
}
...
func (usc *UserSubscriptionChange) assignValues(columns []string, values []interface{}) error {
...
func (usc *UserSubscriptionChange) Update() *UserSubscriptionChangeUpdateOne {
	return (&UserSubscriptionChangeClient{config: usc.config}).UpdateOne(usc)
}
...
func (usc *UserSubscriptionChange) Unwrap() *UserSubscriptionChange {
	...
	if !ok {
		panic("ent: UserSubscriptionChange is not a transactional entity")
	}
...
func (usc *UserSubscriptionChange) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", usc.CreatedAt))
	builder.WriteString(", ")
	builder.WriteString("updated_at=")
	builder.WriteString(fmt.Sprintf("%v", usc.UpdatedAt))
	builder.WriteString(", ")
	builder.WriteString("deleted_at=")
	builder.WriteString(fmt.Sprintf("%v", usc.DeletedAt))
	builder.WriteString(", ")
...
func (usc UserSubscriptionChanges) config(cfg config) {
	for _i := range usc {
		usc[_i].config = cfg
	}
}
