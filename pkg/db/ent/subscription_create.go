...
func (sc *SubscriptionCreate) defaults() error {
	...
	if _, ok := sc.mutation.DeletedAt(); !ok {
		if subscription.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := subscription.DefaultDeletedAt()
		sc.mutation.SetDeletedAt(v)
	}
	if _, ok := sc.mutation.EntID(); !ok {
		if subscription.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := subscription.DefaultEntID()
		sc.mutation.SetEntID(v)
	}
	if _, ok := sc.mutation.AppID(); !ok {
		if subscription.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultAppID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.SortOrder(); !ok {
		if subscription.DefaultSortOrder == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultSortOrder (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.Credit(); !ok {
		if subscription.DefaultCredit == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultCredit (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.QPSLimit(); !ok {
		if subscription.DefaultQPSLimit == nil {
			return fmt.Errorf("ent: uninitialized subscription.DefaultQPSLimit (forgotten import ent/runtime?)")
		}
...
func (sc *SubscriptionCreate) check() error {
	...
	if _, ok := sc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "Subscription.deleted_at"`)}
	}
	if _, ok := sc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "Subscription.ent_id"`)}
	}
	return nil
}
