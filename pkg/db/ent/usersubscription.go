...
func (*UserSubscription) scanValues(columns []string) ([]interface{}, error) {
	values := make([]interface{}, len(columns))
	for i := range columns {
		switch columns[i] {
		case usersubscription.FieldID, usersubscription.FieldCreatedAt, usersubscription.FieldUpdatedAt, usersubscription.FieldDeletedAt, usersubscription.FieldStartAt, usersubscription.FieldEndAt, usersubscription.FieldSubscriptionCredit, usersubscription.FieldAddonCredit:
...
func (us *UserSubscription) assignValues(columns []string, values []interface{}) error {
...
func (us *UserSubscription) Update() *UserSubscriptionUpdateOne {
	return (&UserSubscriptionClient{config: us.config}).UpdateOne(us)
}
...
func (us UserSubscriptions) config(cfg config) {
	for _i := range us {
		us[_i].config = cfg
	}
}
