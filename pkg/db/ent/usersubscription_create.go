...
func (usc *UserSubscriptionCreate) SetCreatedAt(u uint32) *UserSubscriptionCreate {
	usc.mutation.SetCreatedAt(u)
	return usc
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (usc *UserSubscriptionCreate) SetNillableCreatedAt(u *uint32) *UserSubscriptionCreate {
	if u != nil {
		usc.SetCreatedAt(*u)
	}
	return usc
...
func (usc *UserSubscriptionCreate) SetUpdatedAt(u uint32) *UserSubscriptionCreate {
	usc.mutation.SetUpdatedAt(u)
	return usc
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (usc *UserSubscriptionCreate) SetNillableUpdatedAt(u *uint32) *UserSubscriptionCreate {
	if u != nil {
		usc.SetUpdatedAt(*u)
	}
	return usc
...
func (usc *UserSubscriptionCreate) SetDeletedAt(u uint32) *UserSubscriptionCreate {
	usc.mutation.SetDeletedAt(u)
	return usc
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (usc *UserSubscriptionCreate) SetNillableDeletedAt(u *uint32) *UserSubscriptionCreate {
	if u != nil {
		usc.SetDeletedAt(*u)
	}
	return usc
...
func (usc *UserSubscriptionCreate) defaults() error {
	...
	if _, ok := usc.mutation.DeletedAt(); !ok {
		if usersubscription.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized usersubscription.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := usersubscription.DefaultDeletedAt()
		usc.mutation.SetDeletedAt(v)
	}
	if _, ok := usc.mutation.EntID(); !ok {
		if usersubscription.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized usersubscription.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := usersubscription.DefaultEntID()
		usc.mutation.SetEntID(v)
	}
	if _, ok := usc.mutation.AppID(); !ok {
		if usersubscription.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized usersubscription.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := usersubscription.DefaultAppID()
		usc.mutation.SetAppID(v)
	}
	if _, ok := usc.mutation.UserID(); !ok {
		if usersubscription.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized usersubscription.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := usersubscription.DefaultUserID()
		usc.mutation.SetUserID(v)
	}
	if _, ok := usc.mutation.PackageID(); !ok {
		if usersubscription.DefaultPackageID == nil {
			return fmt.Errorf("ent: uninitialized usersubscription.DefaultPackageID (forgotten import ent/runtime?)")
		}
...
func (usc *UserSubscriptionCreate) check() error {
	...
	if _, ok := usc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "UserSubscription.deleted_at"`)}
	}
	if _, ok := usc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "UserSubscription.ent_id"`)}
	}
	return nil
}
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionUpsert) SetCreatedAt(v uint32) *UserSubscriptionUpsert {
...
func (u *UserSubscriptionUpsert) AddCreatedAt(v uint32) *UserSubscriptionUpsert {
	u.Add(usersubscription.FieldCreatedAt, v)
	return u
}

// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionUpsert) SetUpdatedAt(v uint32) *UserSubscriptionUpsert {
...
func (u *UserSubscriptionUpsert) AddUpdatedAt(v uint32) *UserSubscriptionUpsert {
	u.Add(usersubscription.FieldUpdatedAt, v)
	return u
}

// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionUpsert) SetDeletedAt(v uint32) *UserSubscriptionUpsert {
...
func (u *UserSubscriptionUpsert) AddDeletedAt(v uint32) *UserSubscriptionUpsert {
	u.Add(usersubscription.FieldDeletedAt, v)
	return u
}
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionUpsertOne) SetCreatedAt(v uint32) *UserSubscriptionUpsertOne {
...
// AddCreatedAt adds v to the "created_at" field.
func (u *UserSubscriptionUpsertOne) AddCreatedAt(v uint32) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddCreatedAt(v)
	})
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionUpsertOne) SetUpdatedAt(v uint32) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetUpdatedAt(v)
	})
}
...
// AddUpdatedAt adds v to the "updated_at" field.
func (u *UserSubscriptionUpsertOne) AddUpdatedAt(v uint32) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddUpdatedAt(v)
	})
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionUpsertOne) SetDeletedAt(v uint32) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserSubscriptionUpsertOne) AddDeletedAt(v uint32) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddDeletedAt(v)
	})
}
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionUpsertBulk) SetCreatedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetCreatedAt(v)
	})
}
...
// AddCreatedAt adds v to the "created_at" field.
func (u *UserSubscriptionUpsertBulk) AddCreatedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddCreatedAt(v)
	})
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionUpsertBulk) SetUpdatedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetUpdatedAt(v)
	})
}
...
// AddUpdatedAt adds v to the "updated_at" field.
func (u *UserSubscriptionUpsertBulk) AddUpdatedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddUpdatedAt(v)
	})
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionUpsertBulk) SetDeletedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserSubscriptionUpsertBulk) AddDeletedAt(v uint32) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddDeletedAt(v)
	})
}
