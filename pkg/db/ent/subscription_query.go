...
func (sq *SubscriptionQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (sq *SubscriptionQuery) FirstIDX(ctx context.Context) uint32 {
...
func (sq *SubscriptionQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (sq *SubscriptionQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (sq *SubscriptionQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (sq *SubscriptionQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SubscriptionQuery) prepareQuery(ctx context.Context) error {
	...
	if err := subscription.Policy.EvalQuery(ctx, sq); err != nil {
		return err
	}
	return nil
}
