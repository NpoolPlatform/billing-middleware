...
func (uscc *UserSubscriptionChangeCreate) SetCreatedAt(u uint32) *UserSubscriptionChangeCreate {
	uscc.mutation.SetCreatedAt(u)
	return uscc
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (uscc *UserSubscriptionChangeCreate) SetNillableCreatedAt(u *uint32) *UserSubscriptionChangeCreate {
	if u != nil {
		uscc.SetCreatedAt(*u)
	}
	return uscc
...
func (uscc *UserSubscriptionChangeCreate) SetUpdatedAt(u uint32) *UserSubscriptionChangeCreate {
	uscc.mutation.SetUpdatedAt(u)
	return uscc
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (uscc *UserSubscriptionChangeCreate) SetNillableUpdatedAt(u *uint32) *UserSubscriptionChangeCreate {
	if u != nil {
		uscc.SetUpdatedAt(*u)
	}
	return uscc
...
func (uscc *UserSubscriptionChangeCreate) SetDeletedAt(u uint32) *UserSubscriptionChangeCreate {
	uscc.mutation.SetDeletedAt(u)
	return uscc
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (uscc *UserSubscriptionChangeCreate) SetNillableDeletedAt(u *uint32) *UserSubscriptionChangeCreate {
	if u != nil {
		uscc.SetDeletedAt(*u)
	}
	return uscc
...
func (uscc *UserSubscriptionChangeCreate) Save(ctx context.Context) (*UserSubscriptionChange, error) {
	...
	if len(uscc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			uscc.mutation = mutation
			if node, err = uscc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(uscc.hooks) - 1; i >= 0; i-- {
			if uscc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = uscc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, uscc.mutation)
		if err != nil {
			return nil, err
		}
...
func (uscc *UserSubscriptionChangeCreate) defaults() error {
	if _, ok := uscc.mutation.CreatedAt(); !ok {
		if usersubscriptionchange.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultCreatedAt()
		uscc.mutation.SetCreatedAt(v)
	}
	if _, ok := uscc.mutation.UpdatedAt(); !ok {
		if usersubscriptionchange.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultUpdatedAt()
		uscc.mutation.SetUpdatedAt(v)
	}
	if _, ok := uscc.mutation.DeletedAt(); !ok {
		if usersubscriptionchange.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultDeletedAt()
		uscc.mutation.SetDeletedAt(v)
	}
	if _, ok := uscc.mutation.EntID(); !ok {
		if usersubscriptionchange.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultEntID()
		uscc.mutation.SetEntID(v)
	}
	if _, ok := uscc.mutation.AppID(); !ok {
		if usersubscriptionchange.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultAppID()
		uscc.mutation.SetAppID(v)
	}
	if _, ok := uscc.mutation.UserID(); !ok {
		if usersubscriptionchange.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultUserID()
		uscc.mutation.SetUserID(v)
	}
	if _, ok := uscc.mutation.UserSubscriptionID(); !ok {
		if usersubscriptionchange.DefaultUserSubscriptionID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultUserSubscriptionID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := uscc.mutation.OldPackageID(); !ok {
		if usersubscriptionchange.DefaultOldPackageID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultOldPackageID (forgotten import ent/runtime?)")
		}
		v := usersubscriptionchange.DefaultOldPackageID()
		uscc.mutation.SetOldPackageID(v)
	}
	if _, ok := uscc.mutation.NewPackageID(); !ok {
		if usersubscriptionchange.DefaultNewPackageID == nil {
			return fmt.Errorf("ent: uninitialized usersubscriptionchange.DefaultNewPackageID (forgotten import ent/runtime?)")
		}
...
func (uscc *UserSubscriptionChangeCreate) check() error {
	if _, ok := uscc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "UserSubscriptionChange.created_at"`)}
	}
	if _, ok := uscc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "UserSubscriptionChange.updated_at"`)}
	}
	if _, ok := uscc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "UserSubscriptionChange.deleted_at"`)}
	}
	if _, ok := uscc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "UserSubscriptionChange.ent_id"`)}
	}
	return nil
}
...
func (uscc *UserSubscriptionChangeCreate) createSpec() (*UserSubscriptionChange, *sqlgraph.CreateSpec) {
	...
	if value, ok := uscc.mutation.CreatedAt(); ok {
	...
	if value, ok := uscc.mutation.UpdatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
	...
	if value, ok := uscc.mutation.DeletedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionChangeUpsert) SetCreatedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Set(usersubscriptionchange.FieldCreatedAt, v)
	return u
}

// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsert) UpdateCreatedAt() *UserSubscriptionChangeUpsert {
	u.SetExcluded(usersubscriptionchange.FieldCreatedAt)
	return u
}

// AddCreatedAt adds v to the "created_at" field.
func (u *UserSubscriptionChangeUpsert) AddCreatedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Add(usersubscriptionchange.FieldCreatedAt, v)
	return u
}

// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionChangeUpsert) SetUpdatedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Set(usersubscriptionchange.FieldUpdatedAt, v)
	return u
}

// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsert) UpdateUpdatedAt() *UserSubscriptionChangeUpsert {
	u.SetExcluded(usersubscriptionchange.FieldUpdatedAt)
	return u
}

// AddUpdatedAt adds v to the "updated_at" field.
func (u *UserSubscriptionChangeUpsert) AddUpdatedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Add(usersubscriptionchange.FieldUpdatedAt, v)
	return u
}

// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionChangeUpsert) SetDeletedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Set(usersubscriptionchange.FieldDeletedAt, v)
	return u
}

// UpdateDeletedAt sets the "deleted_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsert) UpdateDeletedAt() *UserSubscriptionChangeUpsert {
	u.SetExcluded(usersubscriptionchange.FieldDeletedAt)
	return u
}

// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserSubscriptionChangeUpsert) AddDeletedAt(v uint32) *UserSubscriptionChangeUpsert {
	u.Add(usersubscriptionchange.FieldDeletedAt, v)
	return u
}
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionChangeUpsertOne) SetCreatedAt(v uint32) *UserSubscriptionChangeUpsertOne {
...
// AddCreatedAt adds v to the "created_at" field.
func (u *UserSubscriptionChangeUpsertOne) AddCreatedAt(v uint32) *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddCreatedAt(v)
	})
}
...
// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertOne) UpdateCreatedAt() *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateCreatedAt()
	})
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionChangeUpsertOne) SetUpdatedAt(v uint32) *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.SetUpdatedAt(v)
	})
}
...
// AddUpdatedAt adds v to the "updated_at" field.
func (u *UserSubscriptionChangeUpsertOne) AddUpdatedAt(v uint32) *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddUpdatedAt(v)
	})
}
...
// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertOne) UpdateUpdatedAt() *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateUpdatedAt()
	})
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionChangeUpsertOne) SetDeletedAt(v uint32) *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserSubscriptionChangeUpsertOne) AddDeletedAt(v uint32) *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddDeletedAt(v)
	})
}
...
// UpdateDeletedAt sets the "deleted_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertOne) UpdateDeletedAt() *UserSubscriptionChangeUpsertOne {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateDeletedAt()
	})
}
...
func (u *UserSubscriptionChangeUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for UserSubscriptionChangeCreate.OnConflict")
	}
...
// SetCreatedAt sets the "created_at" field.
func (u *UserSubscriptionChangeUpsertBulk) SetCreatedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.SetCreatedAt(v)
	})
}
...
// AddCreatedAt adds v to the "created_at" field.
func (u *UserSubscriptionChangeUpsertBulk) AddCreatedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddCreatedAt(v)
	})
}
...
// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertBulk) UpdateCreatedAt() *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateCreatedAt()
	})
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *UserSubscriptionChangeUpsertBulk) SetUpdatedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.SetUpdatedAt(v)
	})
}
...
// AddUpdatedAt adds v to the "updated_at" field.
func (u *UserSubscriptionChangeUpsertBulk) AddUpdatedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddUpdatedAt(v)
	})
}
...
// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertBulk) UpdateUpdatedAt() *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateUpdatedAt()
	})
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserSubscriptionChangeUpsertBulk) SetDeletedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserSubscriptionChangeUpsertBulk) AddDeletedAt(v uint32) *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.AddDeletedAt(v)
	})
}
...
// UpdateDeletedAt sets the "deleted_at" field to the value that was provided on create.
func (u *UserSubscriptionChangeUpsertBulk) UpdateDeletedAt() *UserSubscriptionChangeUpsertBulk {
	return u.Update(func(s *UserSubscriptionChangeUpsert) {
		s.UpdateDeletedAt()
	})
}
...
func (u *UserSubscriptionChangeUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the UserSubscriptionChangeCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for UserSubscriptionChangeCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
