module github.com/NpoolPlatform/billing-middleware
...
require (
	...
	github.com/NpoolPlatform/message v0.0.0-20250304091658-85b22ef4f227
	github.com/NpoolPlatform/service-template v0.0.0-20240228101138-6fdcf45612a3
