...
[![Test](https://github.com/NpoolPlatform/billing-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/billing-middleware/actions/workflows/main.yml)
...
* make billing-middleware ```单独编译服务```
* make billing-middleware-image ```单独生成服务镜像```
* make deploy-to-k8s-cluster ```部署到k8s集群```

### 步骤
* 在github上将模板仓库https://github.com/NpoolPlatform/billing-middleware.git import为https://github.com/NpoolPlatform/my-service-name.git
* git clone https://github.com/NpoolPlatform/my-service-name.git
* cd my-service-name
* mv cmd/billing-middleware cmd/my-service
* 修改cmd/my-service/main.go中的serviceName为My Service
* mv cmd/my-service/BillingMiddleware.viper.yaml cmd/my-service/MyService.viper.yaml
* 将cmd/my-service/MyService.viper.yaml中的内容修改为当前服务对应内容
* 修改Dockerfile和k8s部署文档为当前服务对应内容
  * grep -rb "service template" ./*
  * grep -rb "BillingMiddleware" ./*
  * grep -rb "Service Template" ./*
  * grep -rb "service_template" ./*
  * grep -rb "billing-middleware" ./*
  * grep -rb "servicetmpl" ./*
